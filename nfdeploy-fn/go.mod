module github.com/henderiw-nephio/krm-functions/nfdeploy-fn
...
require (
	...
	github.com/nephio-project/nephio/krm-functions/lib v0.0.0-20230512102733-a986c2cde4d1 // indirect
	github.com/nokia/k8s-ipam v0.0.4-0.20230604044109-366c07a61afe // indirect
	k8s.io/api v0.27.2
	k8s.io/apimachinery v0.27.2
)

require github.com/henderiw-nephio/krm-functions/lib v0.0.0-20230605064558-adba31de4fba
